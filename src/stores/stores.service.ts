      ...
      await tx.outboxEvent.create({
        data: {
          ...
          payload: {
            ...
            occurredAt: new Date().toISOString(),
            storeId: id, changedFields: Object.keys(dto), performedBy: actorId,
          },
      ...
      await tx.outboxEvent.create({
        data: {
          ...
          payload: {
            ...
            occurredAt: new Date().toISOString(),
            storeId, action: 'upserted', dayOfWeek: dto.dayOfWeek, performedBy: actorId,
          },
          status: 'PENDING', retryCount: 0,
        },
      });
      ...
      await tx.outboxEvent.create({
        data: {
          ...
          payload: {
            eventType: 'StoreScheduleChanged', eventVersion: 1, correlationId,
            occurredAt: new Date().toISOString(),
            storeId, action: 'updated', scheduleId, performedBy: actorId,
          },
          status: 'PENDING', retryCount: 0,
        },
      });
      ...
      await tx.outboxEvent.create({
        data: {
          ...
          payload: {
            eventType: 'StoreScheduleChanged', eventVersion: 1, correlationId,
            occurredAt: new Date().toISOString(),
            storeId, action: 'deleted', scheduleId, performedBy: actorId,
          },
          status: 'PENDING', retryCount: 0,
        },
      });
      ...
      await tx.outboxEvent.create({
        data: {
          ...
          payload: {
            ...
            occurredAt: new Date().toISOString(),
            storeId, closureId, performedBy: actorId,
          },
          status: 'PENDING', retryCount: 0,
        },
      });
      ...
      await tx.outboxEvent.create({
        data: {
          ...
          payload: {
            eventType: 'StoreStaffChanged', eventVersion: 1, correlationId,
            occurredAt: new Date().toISOString(),
            storeId, userId: staffUserId, action: 'removed', performedBy: actorId,
          },
          status: 'PENDING', retryCount: 0,
        },
      });
